  ...
  return (
    <div style={{ background: "#f1f3f6", minHeight: "100%" }}>
        ...
        >
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(180deg, rgba(0,0,0,.55) 0%, rgba(0,0,0,.18) 30%, rgba(0,0,0,0) 60%)",
              pointerEvents: "none",
            }}
          />
          <div
          ...
          >
            <div style={{ fontSize: 26, fontWeight: 800, letterSpacing: 0.2, textShadow: "0 2px 6px rgba(0,0,0,.45)" }}>
              Customer Service Center
            </div>
            <div style={{ marginTop: 6, fontSize: 13, fontWeight: 600, opacity: 0.95, textShadow: "0 1px 3px rgba(0,0,0,.4)" }}>
      ...
      <section className="wrap" style={{ padding: 12, maxWidth: 540, margin: "12px auto 0" }}>
        ...
        <button type="button" onClick={() => alert("Help – to be added")} style={{ ...rowStyle, marginTop: 12 }}>
          <div style={rowLeftStyle}>
