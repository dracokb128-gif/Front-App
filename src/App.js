...
import { getUsers, getAvatar /*, patchBalance*/ } from "./api";
...
function AvatarRound() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="pic-viewer" onClick={() => setOpen(false)}>
...
function MinePage() {
  ...
  const getVipFromBalance = (bal) =>
    bal >= 901 ? 3 : bal >= 499 ? 2 : bal >= 20 ? 1 : 0;
        ...
        <div className="wrap mine-page">
          ...
          <div className="hero-middle">
            ...
            <div className="hero-ctas">
              <button className="btn btn--deposit" onClick={() => nav("/deposit")} disabled={busy || !me}>
                <FiDownload /><span>{busy ? "..." : "Deposit"}</span>
              </button>
              <button className="btn btn--withdraw" onClick={() => nav("/withdrawal")} disabled={busy || !me}>
...
/* ===== Rest of file unchanged (HomeRoot, routes, etc.) ===== */
